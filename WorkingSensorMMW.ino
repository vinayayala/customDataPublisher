 ...
 * 
 * Code adapted and edited by Vinay Ayala <ayalavinay@gmail.com>
 * ======================================================================= */
...
const int8_t sonarRx = 5;
const int8_t sonarTx = -1;

SoftwareSerial_ExtInts streamName(sonarRx, sonarTx);


MaxBotixSonar sonar1(streamName, SonarPower, SonarTrigger,
                sonar1NumberReadings);

                // Create a new instance of the range variable;
MaxBotixSonar_Range sonar_range(&sonar1);
...
{
    "1b675bbe-7f96-4c1a-9fe4-6e2d422d2324",   // Battery voltage (EnviroDIY_Mayfly_Batt)
    "bbc700d5-5942-4388-872d-1b9c79b54649",   // Temperature (EnviroDIY_Mayfly_Temp)
    "0b663125-235b-4358-b977-5322bd8e7e9f",    // Percent full scale (Digi_Cellular_SignalPercent)
    "29a4e25d-f58b-4674-bfdf-dd0b0c19eec6"    // Distance (MaxBotix_MB7386_Distance)
};
const char *registrationToken = "f3dfd952-e495-46ee-8569-78be0602e106";   // Device registration token
const char *samplingFeature = "13756fa9-3686-462e-972d-ce90dab74ca1";     // Sampling feature UUID
...
// Uploading data interval to the website
uint8_t dataUploadInterval = 1; // In hours
...
CustomPublisher customDataPOST(dataLogger, &modem.gsmClient, registrationToken, samplingFeature, dataUploadInterval);
...
void setup() {
    ...
    streamName.begin(9600);

#if defined SoftwareSerial_ExtInts_h
        enableInterrupt(sonarRx, SoftwareSerial_ExtInts::handle_interrupt, CHANGE);
    #endif
